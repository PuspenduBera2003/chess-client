...
const BouncingDiv = () => {
    ...
    return (
        <animated.div style={{ ...bounceAnimation, cursor: 'pointer' }}>
            ...
            <div className={`w-52 text-gray-900 border border-gray-200 rounded-lg ${isDarkMode} dark:text-white bg-gradient-to-r border border-gray-700 dark:border-gray-400`}>
                <div className="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium border-b border-gray-700 rounded-t-lg  dark:border-gray-500 ">
                ...
                <div className="relative inline-flex items-center w-full px-4 py-2 text-sm font-medium rounded-t-lg  dark:border-gray-600">
