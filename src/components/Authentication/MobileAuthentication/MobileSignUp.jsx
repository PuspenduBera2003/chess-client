        ...
        <div className={`signup`}>
            {
                !signUpInitialized.response.success ?
                    <form autoComplete='off' onSubmit={handleSubmit}>
                        <label className='mobile-auth-label text-gray-100 text-center' htmlFor="chk" aria-hidden="true">Sign Up</label>
                        <div className={`${currentTheme === 'dark' ? 'sign-up-input-dark' : 'sign-up-input-light'} py-2 rounded-xl mx-2 shadow-lg`}>
                            <input
                                className={`mobile-auth-input bg-gray-100 dark:bg-gray-600 p-6 rounded-lg text-black dark:text-white ${currentTheme === 'dark' ? 'dark-placeholder' : 'light-placeholder'}`}
                                type="text"
