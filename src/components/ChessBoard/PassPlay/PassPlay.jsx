      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${navMenuBorder}`}>
        ...
        {/* <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px', width: '400px' }}>
          <button
            onClick={() => {
              safeGameMutate((game) => {
                game.reset();
            ...
            disabled={isGameInInitialState}
            className={`relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 ${isGameInInitialState && 'cursor-not-allowed'}`}
          >
          ...
          <button
            disabled={isGameEnd | isGameInInitialState}
            className={`relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 ${(isGameEnd | isGameInInitialState) && 'cursor-not-allowed'}`}
            onClick={() => {
              safeGameMutate((game) => {
                game.undo();
              });
