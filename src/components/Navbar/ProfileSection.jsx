        ...
        label={
          userDetails.profile_photo ?
            ...
            <div className="flex items-center">
              <svg className="text-gray-400 dark:text-gray-700 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" style={{ width: 40, height: 40 }} fill="currentColor" viewBox="0 0 20 20">
